...
func (req dormitoryRequest) toInput() (service.DormitoryInput, error) {
	...
	return service.DormitoryInput{
		...
		MonthlyPaymentBachelor:  req.MonthlyPaymentBachelor,
		MonthlyPaymentMaster:    req.MonthlyPaymentMaster,
		MonthlyPaymentDoctorate: req.MonthlyPaymentDoctorate,
		YearlyPaymentBachelor:   req.YearlyPaymentBachelor,
		YearlyPaymentMaster:     req.YearlyPaymentMaster,
		YearlyPaymentDoctorate:  req.YearlyPaymentDoctorate,
		BuiltYear:               builtYear,
